...
<div class="container">
  ...
  <p style="color:red; font-size: 24px;
    padding-top: 10px;
    font-weight: bold; width: 100%;" class="plos">Обязательно ознакомьтесь с итоговым список участников Соревнований 2019 года. Участвовать в Соревнованиях могут только те участники, которые есть в списке. Изменения в ФИО участников могут быть внесены не позднее, чем за 12 часов до начала Соревнований</p>
  </div>
</div>
</section>
<section id="rules">
...
2. Номинация «Разработка сервисов для работы с датчиками», победитель - Команда «UNFOX Team», город Люберцы<b>Список участников</b></a><br><br>
    </div>
    </div>
  </div>
</div> 
            ...
            <div class="card-body">
                <div class="flex_img_rules">
                    ...
                    <a href="https://vk.com/doc95748576_526516428?hash=2edbeacbc7e5d0737f&dl=062542489e0ae2b37e" class="btn btn-primary btn_rules"
                    style="margin-top:10px;">Правила игровых ситуаций</a>
                    </div>
                </div>
            </div>
            </div>
